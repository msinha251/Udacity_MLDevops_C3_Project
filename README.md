...
* Download and install conda if you don’t have it already.
   ...
   `conda create -n udacity-c3-project "python=3.8" scikit-learn dvc pandas numpy pytest jupyter jupyterlab fastapi uvicorn -c conda-forge`
   `conda activate udacity-c3-project`
